...
| 阶段 | 里程碑 | 主要功能 | 预计工时 | 优先级 |
|-----|-------|---------|---------|-------|
| Phase 1-3 | 墨灵桌宠 MVP | 桌宠基础、心情系统、灵感气泡 | 4-7天 | P0 |
| Phase 4 | 世界观编辑器 | 人物图谱、势力分布、时间线 | 5-7天 | P1 |
| Phase 5 | 冲突检测 | 设定检测、时间线检测 | 7-10天 | P2 |
| Phase 6 | 连贯性保障 | 记忆库、伏笔追踪 | 8-12天 | P1 |
| Phase 7 | 环境优化 | 护眼模式、白噪音、仪式感 | 3-5天 | P2 |
